...
function Term() {
  ...
  const fetchData = async () => {
    try {
      ...
      const filterData = allData.filter(item => item.typeOfPolicy === 'Terms & Conditions')
  ...
  return (
    <>
      ...
      <div className="container my-3">
        ...
        <p>2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name
        , including the related mobile site and mobile application (hereinafter referred to as ‘Platform’).</p>
        <p>3. The Platform is owned by Mr. Prakash Karn, a company incorporated under the Companies Act, 1956 with its registered office at Om Sri Sale Solutions Pvt. Ltd, 379-B Badarpur, New Delhi, 110044 (hereinafter referred to as ‘Platform Owner’, ‘we’, ‘us’, ‘our’)..</p>
        ...
        <p>5. For the purpose of these Terms of Use, wherever the context so requires ‘you’, ‘your’ or ‘user’ shall For the purpose of these Terms of Use, wherever the context so requires ‘you’, ‘your’ or ‘user’ shall mean any natural or legal person who has agreed to become a user/buyer on the Platform.</p>
        ...
        <p>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Delhi.</p>
